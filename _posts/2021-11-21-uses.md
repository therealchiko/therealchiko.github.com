...
My workspace is a constant work in progress. I believe designing a workspace is an exercise in setting the tone and values of your work. Whether one is aware or not, we all design our workspaces, either intentionally or otherwise. Of late though, I have been making calculated moves to eliminate things that do not work and set an ambience for when i'm working. My decision process of picking equipment is pretty straightforward: I identify a weakness, deep dive into understanding about the potential fixes, then buy something with a money-back guarantee, and friendly return policy (It's a lesson learnt the hard way). My list is not a recommendation list, but a collection of things that work very well __for me__, YMMV. Here we go:
<!--more-->
